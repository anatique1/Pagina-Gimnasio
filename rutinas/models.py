...
class RutinaEjercicio(models.Model):
    ...
    modo = models.CharField(max_length=15, choices=MODO, default='repeticiones')
    duracion = models.IntegerField(default=30)
    unidad_tiempo = models.CharField(max_length=10, choices=UNIDAD_TIEMPO, default='segundos')
    class Meta:
        ordering = ['orden']
